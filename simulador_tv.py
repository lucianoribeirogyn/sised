...
#            "Valor Real": [formatted_Volume, resumo.loc[resumo['Variavel'] == 'formatted_vazaomaa_ano_completo', 'Value'].values[0], formatted_volmaa_ano_completo, resumo.loc[resumo['Variavel'] == 'formatted_qst_ano_completo', 'Value'].values[0], resumo.loc[resumo['Variavel'] == 'formatted_volume_sedimento_ano_completo', 'Value'].values[0], resumo.loc[resumo['Variavel'] == 'formatted_volume_assoreamento_ano_completo', 'Value'].values[0], len(resumo.loc[resumo['Variavel'] == 'bd_reservatorio_selecionado_completo', 'Value'].values[0]), "ln(Qst)="+str(resumo.loc[resumo['Variavel'] == 'formatted_a_coeficiente_completo', 'Value'].values[0])+".ln(vazão)"+resumo.loc[resumo['Variavel'] == 'b_string_completo', 'Value'].values[0]+resumo.loc[resumo['Variavel'] == 'formatted_b_coeficiente_completo', 'Value'].values[0]],
            "Valor Real": ["oi", "oi", "oi", "oi", "oi", "oi", "oi", "oi", "oi",
            "Valor Simulado": [formatted_Volume, resumo.loc[resumo['Variavel'] == 'formatted_vazaomaa_ano', 'Value'].values[0], formatted_volmaa_ano, resumo.loc[resumo['Variavel'] == 'formatted_qst_ano', 'Value'].values[0], resumo.loc[resumo['Variavel'] == 'formatted_volume_sedimento_ano', 'Value'].values[0], resumo.loc[resumo['Variavel'] == 'formatted_volume_assoreamento_ano', 'Value'].values[0], len(data_amostras), "ln(Qst)=="+str(resumo.loc[resumo['Variavel'] == 'formatted_a_coeficiente', 'Value'].values[0])+".ln(vazão)"+resumo.loc[resumo['Variavel'] == 'b_string', 'Value'].values[0]+resumo.loc[resumo['Variavel'] == 'formatted_b_coeficiente', 'Value'].values[0]]
        }
