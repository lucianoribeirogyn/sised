...
if (len(options_anos_vazoes)>0):    
    ...
    with c6:
        ...
        testestr = str(resumo.loc[resumo['Variavel'] == 'b_string_completo', 'Value'].values[0])+str(resumo.loc[resumo['Variavel'] == 'formatted_b_coeficiente_completo', 'Value'].values[0])
        st.write(testestr)
