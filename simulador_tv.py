...
if (len(options_anos_vazoes)>0):    
    ...
    with c6:
        ...
        data_reservatorio_aux = {
            ...
            "Valor Real": ["oi", resumo.loc[resumo['Variavel'] == 'formatted_vazaomaa_ano_completo', 'Value'].values[0], formatted_volmaa_ano_completo, resumo.loc[resumo['Variavel'] == 'formatted_qst_ano_completo', 'Value'].values[0], resumo.loc[resumo['Variavel'] == 'formatted_volume_sedimento_ano_completo', 'Value'].values[0], resumo.loc[resumo['Variavel'] == 'formatted_volume_assoreamento_ano_completo', 'Value'].values[0], len(resumo.loc[resumo['Variavel'] == 'bd_reservatorio_selecionado_completo', 'Value'].values[0]), "ln(Qst)="+str(resumo.loc[resumo['Variavel'] == 'formatted_a_coeficiente_completo', 'Value'].values[0])+".ln(vazão)"+resumo.loc[resumo['Variavel'] == 'b_string_completo', 'Value'].values[0]+resumo.loc[resumo['Variavel'] == 'formatted_b_coeficiente_completo', 'Value'].values[0]],
