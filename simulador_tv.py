...
if (len(options_anos_vazoes)>0):    
    ...
    with c6:
        ...
        data_reservatorio_aux = {
            ...
            "Valor Real": [formatted_Volume, resumo.loc[resumo['Variavel'] == 'formatted_vazaomaa_ano_completo', 'Value'].values[0], formatted_volmaa_ano_completo, resumo.loc[resumo['Variavel'] == 'formatted_qst_ano_completo', 'Value'].values[0], "oi", "oi", "oi", "oi"],
            "Valor Simulado": [formatted_Volume, resumo.loc[resumo['Variavel'] == 'formatted_vazaomaa_ano', 'Value'].values[0], formatted_volmaa_ano, resumo.loc[resumo['Variavel'] == 'formatted_qst_ano', 'Value'].values[0], "oi", "oi", "oi", "oi"]
        }
